...
class Kunena implements iKunena {
	...
	public static function buildVersion() {
		if (self::$version === false) {
			...
			self::$version = ('1.7.1' == '@' . 'kunenaversion' . '@') ? strtoupper ( $version [1] . '-SVN' ) : strtoupper ( '1.7.1' );
			self::$version_date = ('2011-11-16' == '@' . 'kunenaversiondate' . '@') ? $svn [2] : '2011-11-16';
			self::$version_name = ('UnderUret' == '@' . 'kunenaversionname' . '@') ? 'SVN Revision' : 'UnderUret';
			self::$version_build = ('5162' == '@' . 'kunenaversionbuild' . '@') ? $svn [1] : '5162';
		}
		return self::$version;
	}
